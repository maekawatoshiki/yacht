    ...
    pub fn interpret(&mut self, method: &MethodBody, arguments: &[Value]) {
        ...
        loop {
            ...
            match instr {
                ...
                Instruction::Ldc_I4_5 => self.stack_push(Value::Int32(5)),
                Instruction::Ldc_I4_6 => self.stack_push(Value::Int32(6)),
                Instruction::Ldc_I4_7 => self.stack_push(Value::Int32(7)),
